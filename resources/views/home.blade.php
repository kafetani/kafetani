...
<head>
    ...
    <title>Kafetani — Farm to Table</title>
    ...
    <style>
        ...
        .main-nav.scrolled { background: rgba(247,243,236,.97); box-shadow: 0 2px 24px rgba(59,42,26,.1); }
    </style>
</head>
<body>
    ...
    <footer>
        <div class="footer-grid">
            <div class="footer-col">
                <img src="{{ asset('logo_footer.svg') }}" alt="Kafetani" class="footer-logo">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="{{ route('menu') }}" class="footer-link">Menu Kafe</a></li>
                    <li><a href="{{ route('marketplace') }}" class="footer-link">Marketplace</a></li>
                </ul>
            </div>
            <div class="footer-col">
                    ...
                    @auth
                        <li>
                            <a href="{{ route('logout') }}" class="footer-link"
                               onclick="event.preventDefault(); document.getElementById('lf-logout').submit();">Logout</a>
                            <form id="lf-logout" action="{{ route('logout') }}" method="POST">@csrf</form>
                        </li>
                    @else
        ...
        <div class="footer-bottom">© {{ date('Y') }} Kafetani. All rights reserved.</div>
    </footer>
